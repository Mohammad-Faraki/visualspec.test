namespace Tests.Minor.Admin.ObjectMap
{
    ...
    public class AddProperty_AllTypes : UITest
    {
        ...
        public override void RunTest()
        {
            ...
            {
                Utils.AppProperty_ObjectMap(this, C.O1F1, $"P{i + 1}{C.O1F1}", C.propTypes[i], isList: false);
            }

            // Add list types 
            for (int i = 0; i < C.propTypes.Length; i++)
            {
                Utils.AppProperty_ObjectMap(this, C.O1F1, $"P{i + 1 + C.propTypes.Length}{C.O1F1}", C.propTypes[i], isList: true);
            }
        }
