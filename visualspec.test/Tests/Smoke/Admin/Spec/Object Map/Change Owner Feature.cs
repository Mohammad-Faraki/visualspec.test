namespace Tests.Smoke.Admin.ObjectMap
{
    ...
    public class ChangeOwnerFeature : UITest
    {
        ...
        public override void RunTest()
        {
            ...
            AtXPath(Const.formBottomSectionXPath).ClickButton("Save");

            Thread.Sleep(4000);
            Utils.ScrollToTop(this, "objectmap-content");
            ExpectNoXPath($"//span[{Utils.XPathText(Casing.Exact, Const.O1F1)}]");


            Const.OpenFeaturePage(this, Utils.feature02);
