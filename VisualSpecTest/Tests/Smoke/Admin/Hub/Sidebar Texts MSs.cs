namespace Tests.Smoke.Admin.Hub
{
    ...
    public class SidebarTextsMSs : UITest
    {
        ...
        public override void RunTest()
        {
            ...
            ExpectXPath($"//li[4]//ul//li[5]//a[{U.XPathTextContains("User Stories")}]");



            // Deliver
            ClickXPath($"//li[5]//span[{U.XPathTextContains("Deliver")}]");
            WaitToSeeXPath($"//li[5]//ul//li[1]//a[{U.XPathTextContains("Estimate")}]");
        }
