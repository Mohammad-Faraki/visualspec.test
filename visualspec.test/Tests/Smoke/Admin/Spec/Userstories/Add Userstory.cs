namespace Tests.Smoke.Admin.Userstories
{
    ...
    public class AddUserstory : UITest
    {
        ...
        public override void RunTest()
        {
            ...
            Set(That.Contains, "Description").To(Const.addedUserstory);
            ...
            //Expect(newUserstory);
            Utils.ScrollToBottom(this, Shared.Admin.Userstories.Const.scrollable_mainContent);
            ExpectXPath($"//tr[last()]//*[text()='{Const.addedUserstory}']");
        }
    }
}
